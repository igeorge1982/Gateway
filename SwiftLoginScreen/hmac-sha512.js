...
function HmacSHA512(string, secret){
    

        var encrypted = CryptoJS.HmacSHA512(string, secret);
        var encoded = CryptoJS.enc.Base64.stringify(encrypted);
                                                      
    return encoded;
}

function HmacSHA512_(string, secret){
        
        var encrypted = CryptoJS.HmacSHA512(string, secret).toString(CryptoJS.enc.Base64);
